...
export const Services: React.FC = () => {
    return (
        <section id="servicos" className="py-20 bg-[#02050a]">
            <div className="container mx-auto px-6">
                <AnimatedSection>
                    <h2 className="font-display text-3xl md:text-4xl text-white font-bold text-center mb-4">Soluções Completas para sua Presença Online</h2>
                ...
                <AnimatedSection>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service, index) => (
                            <div key={index} className="bg-gray-200 p-8 rounded-lg shadow-md text-center transform hover:-translate-y-2 transition-transform duration-300">
